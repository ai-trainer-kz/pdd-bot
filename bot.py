    ...
    templates = [
        {
            ...
            "options": ["Уступить дорогу", "Продолжить движение", "Остановиться", "Подать сигнал"],
            "correct": random.randint(0, 3),
            "explanation": "Водитель должен действовать согласно правилам дорожного движения."
        },
        {
            "q": "Разрешено ли движение в данной ситуации?",
            "options": ["Разрешено", "Запрещено", "Разрешено с ограничениями", "По ситуации"],
            "correct": random.randint(0, 2),
            "explanation": "Необходимо соблюдать требования дорожных знаков и разметки."
        },
        {
            "q": "Как обязан поступить водитель?",
            "options": ["Снизить скорость", "Продолжить движение", "Остановиться", "Изменить направление"],
            "correct": random.randint(0, 3),
            "explanation": "Действия водителя должны соответствовать ПДД."
        }
    ]
