...
{
    "q": "Разрешён ли обгон непосредственно перед железнодорожным переездом?",
    "options": [
        "Разрешён",
        "Разрешён при отсутствии поезда",
        "Запрещён",
        "Разрешён только вне населённого пункта"
    ],
    "correct": 2,
    "explanation": "Обгон перед железнодорожным переездом запрещён."
},

{
    "q": "Можно ли останавливаться на пешеходном переходе?",
    "options": [
        "Можно",
        "Можно для посадки пассажира",
        "Запрещено",
        "Можно ночью"
    ],
    "correct": 2,
...
{
    "q": "Кто должен уступить дорогу на перекрёстке равнозначных дорог?",
    "options": [
        "Тот, кто справа",
    ...
    "correct": 1,
    "explanation": "Действует правило помехи справа."
}
